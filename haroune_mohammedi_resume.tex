...
\location{May 2022 – Present | Paris, France}
...
\item Strong communication skills, work on a fully remote environment for more than a year.
\end{tightemize}
\sectionsep
\sectionsep
...
\begin{tightemize}
\sectionsep
\item Fulfill my curiosity and explore how to make DSLs in Scala.
\end{tightemize}
...
\sectionsep
\href{https://www.linkedin.com/in/jhadjar/}{\textbf{Jugurta Hadjar}}, CTO, COO, CPO, BigMama Technology, Algeria
\\
\begingroup
\setbox0=\hbox{
